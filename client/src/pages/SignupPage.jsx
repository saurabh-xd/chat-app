  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex items-center justify-center  sm:justify-evenly max-sm:flex-col backdrop-blur-2xl px-4">
      <div className="flex flex-col items-center justify-center md:gap-2 gap-0 max-sm:mb-8">
        <h2 className="text-neutral-100 text-3xl md:text-6xl">
          Welcome to <span className="text-teal-500 font-bold">ChatMate</span>
        </h2>
        <p className="text-neutral-300 text-sm md:text-2xl">
          Continue chatting with your mates instantly.
        </p>
      </div>
      ...
      >
        ...
        <button
          type="submit"
          className="text-sm md:text-base py-2.5  md:py-3 bg-gradient-to-r from-teal-400 to-teal-700 text-white rounded-md cursor-pointer flex items-center justify-center gap-1 hover:opacity-90"
        >
          {loading ? (
            <>
